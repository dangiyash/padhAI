...
export default function AssessmentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Format answers into an array of objects with questionId and answer
      ...
      if (!response.ok) {
        throw new Error(data.error || data.details || "Error evaluating answers");
      }
      ...
      setError(error instanceof Error ? error.message : "Failed to evaluate answers. Please try again.");
    } finally {
      setEvaluating(false);
    }
  };
